               ...
               <body>
                  <div class="page"><div class="page__content">
                      <div class="page__header">
                          <h1><?php echo JText::_('COM_ZOHOZEPTO_LABEL_SENDMAIL'); ?> <span class="ico-send"></span></h1>
                      </div>
                      <div class="form">
                       <div class="form__row">
                        <label class="form--label"><?php echo JText::_('COM_ZOHOZEPTO_LABEL_TO'); ?></label>
                        <input type="text" class="form--input" name="zeptomail_to_address" value="<?php echo $to; ?>" required = "required"/> </div>
                        <div class="form__row">
                            <label class="form--label"><?php echo JText::_('COM_ZOHOZEPTO_LABEL_MAILTYPE'); ?></label>
                        ...
                        <div class="form__row">
                            <label class="form--label" ><?php echo JText::_('COM_ZOHOZEPTO_LABEL_SUBJECT'); ?></label>
                            ...
                            <div class="form__row">
                             <label class="form--label"><?php echo JText::_('COM_ZOHOZEPTO_LABEL_CONTENT'); ?></label>
                             <textarea class="form--input" name="zeptomail_content" ><?php echo SettingsHelper::zepto_escape($content); ?></textarea> </div>
                             <div class="form__row form__row-btn"> <input type="submit" class = "btn" name="zeptomail_send_mail_submit" id="zeptomail_send_mail_submit" value="<?php echo JText::_('COM_ZOHOZEPTO_LABEL_SENDMAIL'); ?>">
